                            ...
                            <! <div class="form-group captcha-group">
                                ...
                                <! <input type="text" name="captcha" id="captcha" required autocomplete="off">
                                    ...
                                    <div class="error-message">
                                        ...
                                        <?php echo htmlspecialchars($captcha_error); ?>
                                    </div>
                                    <?php endif; ?>
                                    </div>
                                    <! <div class="form-group remember-me">
                                        ...
                                        <a href="<?= BASE_URL ?>forgot-password" class="forgot-password">Forgot
                                            Password?</a>
                                        </div>
                                        <! <div class="form-group">
                                            ...
                                            <! <aside class="register-link">
                                                <p>Don't have an account? <a href="<?= BASE_URL ?>register">Register
                                                        here</a></p>
                                                </aside>
                                                </div>
                                                <! </div>
