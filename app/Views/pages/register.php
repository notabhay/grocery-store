    ...
    <! <section class="register-section">
        <! <div class="container">
            ...
            ?> <div class="alert alert-success">
                    <p>Registration successful! You can now <a href="<?= BASE_URL ?>login">login</a> to your account.
                    </p>
                    </div>
            ...
            ?>
                    <! <div id="register-form-container">
                        <! <p>Loading registration form...</p>
                            ...
                            <! <noscript>
                                <! <p style="color: red; text-align: center; margin-bottom: 1em;">JavaScript is required
                                    for the
                                                                                        ...
                                                                                        <! </main>
                                                                                            <! <! <! <script
                                                                                                ...
                                                                                                <! <script
                                                                                                    ...
                                                                                                    <! <script
                                                                                                        type="text/babel"
                                                                                                        src="<?= BASE_URL ?>assets/js/react_components/RegistrationForm.js">
                                                                                                        </script>
                                                                                                        <! <script
                                                                                                            type="text/babel">
                                                                                                            const
