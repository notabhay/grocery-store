                ...
                <div class="contact-form-wrapper">
                    ...
                    <form class="contact-form" method="POST" action="<?= BASE_URL ?>contact/submit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" value="<?= htmlspecialchars($old_input['email'] ?? '') 
                                                                                ?>" required>
                            <?php 
                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" rows="5" required><?= htmlspecialchars($old_input['message'] ?? '') 
                                                                                    ?></textarea>
                            <?php 
                            ?>
