                        ...
                        <! <div class="product-details">
                            <! <img src="<?= BASE_URL ?>assets/images/products/<?php echo htmlspecialchars(basename($product['image_path'] ?? 'default.png')); 
                                ...
                                <! <div class="product-info">
                                    ...
                                    <div class="product-price">$<?php echo number_format($product['price'], 2); ?> per
                                        unit</div>
                                    <div class="product-stock">
                                        <span class="stock-label">In Stock:</span>
                                        <span
                                            class="stock-value"><?php echo htmlspecialchars($product['stock_quantity']); ?>
                                            units</span>
                                    </div>
                                    </div>
                                    </div>
                                                            ...
                                                            <div class="quantity-controls">
                                                                <! <button type="button"
                                                                    ...
                                                                    <! <input type="number" id="quantity"
                                                                        name="quantity" class="quantity-input" value="1"
                                                                        min="1" max="<?php echo htmlspecialchars($product['stock_quantity']); 
                                                                        ...
                                                                        <! <div class="payment-methods">
                                                                            ...
                                                                            <! <div class="payment-option">
                                                                                <input type="radio" id="payment_cash"
                                                                                    ...
                                                                                    checked>
                                                                                <label for="payment_cash">Cash on
                                                                                    Delivery</label>
                                                                                </div>
                                                                                </div>
                                                                                                    ...
                                                                                                    <! </div>
                                                                                                        <! </main>
                                                                                                            <! <!
                                                                                                                ...
                                                                                                                decreaseBtn
                                                                                                                =
                                                                                                                document.querySelector('.quantity-btn.decrease-btn');
                                                                                                                const
                                                                                                                increaseBtn
                                                                                                                =
                                                                                                                document.querySelector('.quantity-btn.increase-btn');
                                                                                                                const
                                                                                                                quantityValueSpan
                                                                                                                =
                                                                                                                ...
                                                                                                                productPrice
                                                                                                                =
                                                                                                                parseFloat(quantityInput.getAttribute('data-price'));
                                                                                                                const
                                                                                                                maxQuantity
                                                                                                                =
