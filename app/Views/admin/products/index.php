                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <form action="<?= BASE_URL ?>admin/products/<?php echo $product['product_id']; ?>/toggle-active"
                                    method="POST" class="d-inline"> <?php 
                                                                    ?>
                                    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                                    <button type="submit" class="btn btn-sm <?php echo $product['is_active'] ? 'btn-warning' : 'btn-success'; 
                                                                            ?>">
                                        <i class="fas <?php echo $product['is_active'] ? 'fa-ban' : 'fa-check'; 
                                                        ?>"></i>
