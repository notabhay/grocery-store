                            ...
                            <! <div class="form-group">
                                ...
                                <! <div class="form-group">
                                    ...
                                    <! <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Accepted formats: JPG, PNG, GIF, WEBP.
                                            Maximum size: 5MB. Leave
                                            empty to keep the current image.</small>
                                        </div>
                                        <! <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="is_active"
                                                    name="is_active" value="1" <?php echo $product['is_active'] ? 'checked' : '';
                                                                                ?>>
                                                <label class="custom-control-label" for="is_active">Active (available
                                                    for purchase)</label>
                                            </div>
                                            </div>
