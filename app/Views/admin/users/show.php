                            ...
                            <! <div class="detail-item">
                                ...
                                <! <div class="detail-item">
                                    ...
                                    <! <div class="detail-item">
                                        ...
                                        <span
                                            class="detail-value"><?php echo htmlspecialchars($user['phone']); ?></span>
                                        </div>
                                        <! <div class="detail-item">
                                                ...
                                                <! <div class="detail-item">
                                                    ...
                                                    <! </div>
                                                        <! <! <div class="user-details-section">
                                                            ...
                                                            <p>Use this option to send a password reset email to the
                                                                user.</p>
                                                            <! <form
                                                                action="<?= BASE_URL ?>admin/users/<?php echo $user['user_id']; ?>/reset-password"
