                ...
                <! <thead>
                    ...
                    <! <tbody>
                                                    ...
                                                    <! <td><?php echo htmlspecialchars(date('M d, Y', strtotime($user['registration_date'])));
                                                        ...
                                                        <! <td class="actions">
                                                            <! <a href="<?= BASE_URL ?>admin/users/<?php echo $user['user_id'];
                                                                ...
                                                                <! <a
                                                                    href="<?= BASE_URL ?>admin/users/<?php echo $user['user_id']; ?>/edit"
                        ...
                        <! <?php
                            ...
                            ?>
                            <a href="<?= BASE_URL ?>admin/users?page=<?php echo $i; ?>"
                            ...
                            <a href="<?= BASE_URL ?>admin/users?page=<?php echo $pagination['current_page'] + 1; ?>"
                                ...
                                &rsaquo;</a>
                            <a href="<?= BASE_URL ?>admin/users?page=<?php echo $pagination['total_pages']; ?>"
